...
Coinbase, Stripe, Cloudflare, OpenAI, and Exa.ai have all shipped agent-facing infrastructure in the last ninety days. Agents can now [hold and spend](https://www.coinbase.com/developer-platform/discover/launches/agentic-wallets) cryptocurrency, make [payments](https://stripe.com/payments/ai) through commerce APIs, read websites as clean [machine-readable](https://blog.cloudflare.com/markdown-for-agents/) text, search the web with purpose-built engines, and run code in real terminal environments. These aren't prototypes. They're production systems from companies that don't ship things for fun.
