...
Many don't realize they are using AI when they click those buttons. They think they are using software. They are not. They are triggering a different system with its own rules, its own identity, and its own opinions about privacy.

Fewer still think about which account is being used to trigger the AI and how that might affect the data they are working with.
...
From her point of view, nothing unusual had happened. What she could not see was that her browser was logged into a personal Google profile. The AI behind that suggestion followed the profile, not the account tied to her document. The entire interaction traveled through a personal identity sitting outside her organization’s protected boundary.
...
That is exactly what makes them risky.
...
Enterprise AI tools like Copilot for Microsoft 365 or Gemini for Nonprofits are built to protect organizational data. They stay inside your tenant. They do not train public models. They follow contracts and admin controls. They behave like part of your institution.

Consumer AI does not. Some services train on personal data unless settings are changed. Others allow human review. Many offer no organizational boundary at all. Enterprise AI from Microsoft, Google, OpenAI, and Anthropic is built around contractual protections and tenant boundaries, while the consumer versions of those same tools follow completely different rules.

Both versions of AI sit in the same window. They look identical. A single click can move a staff member from one world to the other without any signal that it happened.
...
**Green data** is public-facing material. Policies, grant drafts, marketing content, training materials. Staff can use consumer tools here without much concern.

**Yellow data** is rooted in real client work but lacks personal identifiers. This belongs in enterprise AI only, where you have contractual protections and a managed environment.
...
If you have access to support from your technology provider, ask them to help you implement this habit by default in the browser settings used on or organization's devices. It is a simple change that can have a big impact.
