      ...
      <div className="container mx-auto px-4 relative">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <Link
              href="/"
              className={`text-xl font-bold transition-colors duration-300 focus-ring ${
                ...
                if (isHashLink) {
                  return (
                    <a
                      key={item.href}
                      href={item.href}
                      className={`px-3 py-2 text-sm font-medium transition-colors duration-300 hover:opacity-80 touch-target ${
                        isScrolled
          ...
          <div className="md:hidden">
            <button
              ...
              className={`inline-flex items-center justify-center p-2 rounded-md transition-colors duration-300 touch-target ${
                isScrolled
                ...
                if (isHashLink) {
                  return (
                    <a
                      key={item.href}
                      href={item.href}
                      className={`block px-3 py-2 text-base font-medium transition-colors duration-300 hover:opacity-80 touch-target ${
                        isScrolled
